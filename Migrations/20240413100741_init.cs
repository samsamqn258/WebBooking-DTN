    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelTypes", x => x.TypeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaID = table.Column<int>(type: "int", nullable: false),
                    UserID = table.Column<int>(type: "int", nullable: false),
                    HotelTypeTypeID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Hotels_HotelTypes_HotelTypeTypeID",
                        column: x => x.HotelTypeTypeID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPriceBooking = table.Column<double>(type: "float", nullable: false),
                    RoomID = table.Column<int>(type: "int", nullable: false),
                    UserID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CancelBookings", x => x.CancelID);
                    table.ForeignKey(
                        name: "FK_CancelBookings_Bookings_BookingID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeID = table.Column<int>(type: "int", nullable: false),
                    BookingID = table.Column<int>(type: "int", nullable: false),
                    PaymentTypeTypeID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_PaymentTypes_PaymentTypeTypeID",
                        column: x => x.PaymentTypeTypeID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CancelBookings_BookingID",
                table: "CancelBookings",
                column: "BookingID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hotels_HotelTypeTypeID",
                table: "Hotels",
                column: "HotelTypeTypeID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_PaymentTypeTypeID",
                table: "Payments",
                column: "PaymentTypeTypeID");
